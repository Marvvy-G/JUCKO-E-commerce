const PayStack = () => {
    return (
        ...
        <path  d="M83.3,377.2H2.9c-2.7,0-5,2.3-5,5.1v9.1c0,2.8,2.3,5.1,5,5.1h80.4c2.8,0,5-2.3,5.1-5.1v-9
            ...
            />
        <path  d="M181.9,397.6c-2.5-2.6-5.4-4.6-8.7-6s-6.8-2.1-10.4-2.1c-3.5-0.1-6.9,0.7-10.1,2.2c-2.1,1-4,2.4-5.6,4.1v-1.6
