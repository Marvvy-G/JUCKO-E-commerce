...
const TermsAndConditionsTemplate: React.FC = () => {
  return (
    <div data-custom-class="body" className="content-container flex flex-col justify-center items-center gap-y-8 max-w-4xl h-full w-full">
      <div >
      <Heading level='h2' className="pt-6 flex flex-row text-3xl-regular"> TERMS AND CONDITIONS</Heading>
        <div   style={{ lineHeight: '1.5' }}>
          <br />
        </div>
        <div   data-custom-class="body_text">
          <p><b>Last updatedFebruary 07, 2024</b></p>
        </div>
      ...
      <div   style={{ textAlign: 'left' }}>
        <div   data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
          We are <b>JUCKO GLOBAL</b> ('<strong>Company</strong>', '<strong>we</strong>', '<strong>us</strong>', or '<strong>our</strong>').{' '}
        </div>
      </div>
      
      <div   style={{ textAlign: 'left' }}>
        <div   data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
          We operate the website <span style={{ color: '#003AF0' }}>jucko.com</span> (the '<strong>Site</strong>'), as well as any other related
          products and services that refer or link to these legal terms (the '<strong>Legal Terms</strong>') (collectively, the '<strong>Services</strong>').{' '}
        </div>
        <div   style={{ lineHeight: '1' }}>
          <br />
        </div>
        <div   data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
          You can contact us by phone at <b>+2348025646472</b> or by email at <b>contact@jucko.com</b>
        </div>
        <div   style={{ lineHeight: '1' }}>
          <br />
        </div>
        <div   data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
          ...
          and <b>JUCKO GLOBAL</b>, concerning your access to and use of the Services. You agree that by accessing the Services, you have read,
      ...
      <div   style={{ textAlign: 'left' }}>
        <div   data-custom-class="body_text" style={{ lineHeight: '1.5' }}>
          The Services are intended for users who are at least 13 years of age. All users who are minors in the jurisdiction in which they reside
          (generally under the age of 18) must have the permission of, and be directly supervised by, their parent or guardian to use the Services. If
          you are a minor, you must have your parent or guardian read and agree to these Legal Terms prior to you using the Services.{' '}
        </div>
      </div>
      <div>
    ...
    <div   style={{ lineHeight: '1.5', color: 'rgb(0, 58, 250)', fontSize: '15px' }}>
    <ul>
    <li>  
    ...
    <li>  
      ...
      <a data-custom-class="link" href="#products">
          <span data-custom-class="body_text"> 5. PRODUCTS</span>
      </a>
      </li>
     <li>
     <a data-custom-class="link" href="#purchases">
          <span data-custom-class="body_text"> 6. PURCHASES AND PAYMENT</span>
      </a>
     </li>
     <li>
     <a data-custom-class="link" href="#returnyes">
          <span data-custom-class="body_text">  7. RETURN POLICY</span>
      </a>
     </li>
     <li>
     ...
     <li>
     <a data-custom-class="link" href="#ugu">
     ...
     <a data-custom-class="link" href="#thirdparty">
          <span data-custom-class="body_text">  11. THIRD PARTY WEBSITES AND CONTENT</span>
      </a>
     </li>
     <li>
     ...
     <a data-custom-class="link" href="#modifications">
          <span data-custom-class="body_text">  15. MODIFICATIONS AND INTERRUPTIONS </span>
      </a>
     </li>
     <li>
     ...
     <li>
     <a data-custom-class="link" href="#dispute">
          <span data-custom-class="body_text">  17. DISPUTE RESOLUTION</span>
      </a>
     </li>
     <li>
     <a data-custom-class="link" href="#correction">
     ...
     <a data-custom-class="link" href="#electronic">
          <span data-custom-class="body_text"> 23. ELECTRONIC COMMUNICATIONS, TRANSACTIONS AND SIGNATURES </span>
      </a>
     </li>
     <li>
     <a data-custom-class="link" href="#califoRnia">
          <span data-custom-class="body_text"> 24. CALIFORNIA USERS AND RESIDENTS </span>
      </a>
     </li>
     <li>
    ...
    <br />
      ...
      solely for your personal, non-commercial use. Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission.
      If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: contact@jucko.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
...
<div   style={{ lineHeight: '1' }}>
    ...
    By using the Services, you represent and warrant that: (1) all registration information you submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and promptly update such registration information as necessary; (3) you have the legal capacity and you agree to comply with these Legal Terms; (4) you are not under the age of 13; (5) you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Services; (6) you will not access the Services through automated or non-human means, whether through a bot, script or otherwise; (7) you will not use the Services for any illegal or unauthorised purpose; and (8) your use of the Services will not violate any applicable law or regulation.    <br />
    ...
    <ul>
      ...
      <li>MasterCard</li>
            ...
            <br />
            You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in NGN, USD, EUR.
            <br />
    ...
    <p>The Services does not offer users to submit or post content.
    ...
    <p>These Legal Terms shall be governed by and defined following the laws of Nigeria. JUCKO GLOBAL and yourself irrevocably consent that the courts of Nigeria shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
    </div>
    ...
    <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us via email at contact@jucko.com
    </p>
    </div>
    <div   style={{ lineHeight: '1' }}>
        <br />
