...
const PrivacyTemplate= () => {
  return (
    <div className="content-container flex flex-col justify-center items-center gap-y-8 max-w-4xl h-full w-full">
      ...
      <Heading level='h2' className="pt-6 flex flex-row text-3xl-regular"> PRIVACY POLICY</Heading>
        <span>Last updated February 06, 2024</span>
          <p>This privacy notice for Jucko.com (doing business as <strong>Jucko Global LTD, JUCKO</strong>) (&apos;we&apos;, &apos;us&apos;, or &apos;our&apos;), 
          ...
          such as when you:
          Visit our website or any website of ours that links to this privacy notice or
         ...
         <span className="font-bold">Questions or concerns?</span>
          <p>Reading this privacy notice will help you understand your privacy rights and choices. 
            ...
            If you still have any questions or concerns, please contact us at contact@jucko.com.
          </p>
          </div>
          <div>
    ...
    <div>
          ...
          <br /><p> <strong>Do we process any sensitive personal information?</strong>We do not process sensitive personal information.</p>
          <br /><p><strong>Do we receive any information from third parties? </strong>We do not receive any information from third parties.</p>
          <br /><p><strong>How do we process your information?</strong> We process your information to provide, improve, and administer our Services, communicate with you, for security and fraud prevention, and to comply with law. We may also process your information for other purposes with your consent. We process your information only when we have a valid legal reason to do so. </p>
          <br /><p><strong>In what situations and with which parties do we share personal information?</strong> We may share information in specific situations and with specific third parties. </p>
          <br /><p><strong>How do we keep your information safe?</strong> We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information.</p>
          <br /><p><strong>What are your rights?</strong> Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information.</p>
          <br /><p><strong>How do you exercise your rights? </strong> The easiest way to exercise your rights is by submitting a data subject access request, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
          <br /><p><strong>Want to learn more about what we do with any information we collect?</strong> Review the privacy notice in full.</p> 
    ...
    <li>WHEN AND WITH WHOM DO WE SHARE YOUR PERSO3NAL INFORMATION?</li>
    ...
    <div>
        ...
        <p> 
        <strong>Payment Data.</strong> We may collect data necessary to process your payment if you make purchases, such as your payment instrument number, and the security code associated with your payment instrument. 
        All payment data is stored by Paystack. You may find their privacy notice link(s) here: <Link href="https://paystack.com/privacy/merchant">https://paystack.com/privacy/merchant.</Link>  <br />
        All personal information that you provide to us must be true, complete, and accurate, and you must notify us of any changes to such personal information.
        </p>
        <p><strong>Information automatically collected.</strong>
        <span>In Short: Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.</span>
        We automatically collect certain information when you visit, use, or navigate the Services. This information does not reveal your specific identity (like your name or contact information) but may include device and usage information, such as your IP address, browser and device characteristics, operating system, language preferences, referring URLs, device name, country, location, information about how and when you use our Services, and other technical information. This information is primarily needed to maintain the security and operation of our services and for our internal analytics and reporting purposes.
        Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: <Link href='jucko.com/cookiepolicy'>jucko.com/cookiepolicy</Link>.
        <br />
        The information we collect includes:
        <br />
        </p>
       <p> <strong>Log and Usage Data.</strong> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. 
    ...
    For more information see our Cookie Notice: <Link href='jucko.com/cookiepolicy'>jucko.com/cookiepolicy</Link>.
   ...
   <ol>Send users information about special offers and discounts on our products and services
    ...
    <p>We may process your information where we believe it is necessary for compliance with our legal obligations, such as to cooperate with a law enforcement body or regulatory agency, exercise or defend our legal rights, or disclose your information as evidence in litigation in which we are involved.
    Vital Interests. We may process your information where we believe it is necessary to protect your vital interests or the vital interests of a third party, such as situations involving potential threats to the safety of any person.
    </p>
      </div>
          
    <div>  
   <span> If you are located in Canada, this section applies to you.</span>
    
    <p>
    We may process your information if you have given us specific permission (i.e. express consent) to use your personal information for a specific purpose, or in situations where your permission can 
    ...
    <div>
        ...
        Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <Link href='jucko.com/cookiepolicy'>jucko.com/cookiepolicy</Link>.
        </p>
    </div>
   ...
   <strong>Cookies and similar technologies:</strong> <br /> Most Web browsers are set to accept cookies by default. 
    ...
    For further information, please see our Cookie Notice: <Link href='jucko.com/cookiepolicy'>jucko.com/cookiepolicy</Link>
    
    
    If you have questions or comments about your privacy rights, you may email us at contact@jucko.com.
    </p>
  ...
  <div>  
   ...
   <div>
    <h5>10. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h5> 
    ...
    NO.D. Commercial information
      Transaction information, purchase history, financial details, and payment information.
    NO.E. Biometric information
      Fingerprints and voiceprints.
    NO.F. Internet or other similar network activity
      Browsing history, search history, online behaviour, interest data, and interactions with our and other websites, applications, systems, and advertisements.
    NO.G. Geolocation data
      Device location.
    ...
    NO.J. Education Information
      Student records and directory information.
    NO.K. Inferences drawn from collected personal information
      Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics.
    NO.L. Sensitive personal Information .NO.
   ...
   <strong>How do we use and share your personal information?.</strong> 
    ...
    Learn more about how we disclose personal information to in the section below</div>
  ...
  <div> 
      ...
      <p>  We may use your personal information for our own business purposes, such as for undertaking internal research for technological development and demonstration. This is not considered to be &apos;selling&apos; of your personal information.
        ...
        California Residents.California Civil Code Section 1798.83, also known as the &apos;Shine The Light&apos; law permits our users who are California residents to request and obtain from us, once a year and free of charge, 
   ...
   <p> This section applies only to California residents. Under the California Consumer Privacy Act (CCPA), you have the rights listed below.
    ...
    Your rights with respect to your personal data. Right to request deletion of the data — Request to delete.You can ask for the deletion of your personal information. 
    If you ask us to delete your personal information, we will respect your request and delete your personal information, 
    subject to certain exceptions provided by law, such as (but not limited to) the exercise by another consumer of his or her right to free speech, our compliance requirements resulting from a legal obligation, 
    ...
    Verification process.Upon receiving your request, we will need to verify your identity to determine you are the same person about whom we have the information in our system. 
    These verification efforts require us to ask you to provide information so that we can match it with information you have previously provided us.
     For instance, depending on the type of request you submit, we may ask you to provide certain information so that we can match the information you provide with the information we already have on file, 
    ...
    we may request that you provide additional information for the purposes of verifying your identity and for security or fraud-prevention purposes. 
    ...
    <div>
      <h5>Other privacy rights</h5> 
        ...
        To exercise these rights, you can contact us by submitting a data subject access request, by visiting jucko/contact.com, or by referring to the contact details at the bottom of this document. 
        If you have a complaint about how we handle your data, we would like to hear from you.
        </p>

        <h5>Colorado Residents.</h5>
          <p> This section applies only to Colorado residents. 
            ...
            ARight to opt out of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects (&apos;profiling&apos;)
            To submit a request to exercise these rights described above, please email contact@jucko.com or submit a data subject access request.
            If we decline to take action regarding your request and you wish to appeal our decision, please email us at contact@jucko.com. Within forty-five (45) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.
            Connecticut Residents.This section applies only to Connecticut residents. Under the Connecticut Data Privacy Act (CTDPA), you have the rights listed below. However, these rights are not absolute, and in certain cases, we may decline your request as permitted by law.
            Right to be informed whether or not we are processing your personal data
            Right to access your personal data
            Right to correct inaccuracies in your personal data
            Right to request deletion of your personal data
            ...
            To submit a request to exercise these rights described above, please email contact@jucko.com or submit a data subject access request.
            If we decline to take action regarding your request and you wish to appeal our decision, please email us at contact@jucko.com. Within sixty (60) days of receipt of an appeal, we will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions.
            </p>
    
          <h5> Utah Residents.</h5>
            
            <p>This section applies only to Utah residents. Under the Utah Consumer Privacy Act (UCPA), you have the rights listed below. However, these rights are not absolute, and in certain cases, we may decline your request as permitted by law.
              Right to be informed whether or not we are processing your personal data
              Right to access your personal data
              Right to request deletion of your personal data
              Right to obtain a copy of the personal data you previously shared with us
      ...
      Right to obtain a copy of the personal data you previously shared with us
      Right to opt out of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects (&apos;profiling&apos;)
      Exercise your rights provided under the Virginia VCDPA.You may contact us by email at contact@jucko.com or submit a data subject access request.
      ...
      Verification process.We may request that you provide additional information reasonably necessary to verify you and your consumer&apos;s request. 
      If you submit the request through an authorised agent, we may need to collect additional information to verify your identity before processing your request.
      Upon receiving your request, we will respond without undue delay, but in all cases, within forty-five (45) days of receipt. 
      The response period may be extended once by forty-five (45) additional days when reasonably necessary. We will inform you of any such extension within the initial 45-day response period, together with the reason for the extension.
   
   <br/> 
   
   <span>Right to appeal.</span>
   <br />
    If we decline to take action regarding your request, we will inform you of our decision and reasoning behind it. 
    If you wish to appeal our decision, please email us at contact@jucko.com. Within sixty (60) days of receipt of an appeal, 
    ...
    <div className='p-b=1'>
      <h5>11. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h5> 
      <p>
       ...
       <p>
        ...
        <h5> 12. NIGERIAN RESIDENTS.</h5>
        <p>
        We comply with the Nigeria Data Protection Act, 2023 (the Act), which regulates the processing of personal data in Nigeria. 
        The Act defines personal data as any information relating to an identified or identifiable natural person. 
        The Act also provides you with certain rights over your personal data, such as the right to access, correct, delete, or object to the processing of your data. 
        We collect, use, share, and protect your personal data for the purposes and on the legal bases described in this privacy policy. 
        We only collect the personal data that is necessary for the provision of our services, the improvement of our website, the communication with you, or the compliance with the law. 
        We do not sell or rent your personal data to third parties without your consent. You have the right to access, correct, delete, or object to the processing of your personal data at any time. 
        You can exercise these rights by contacting us at privacy@yourwebsite.com. You also have the right to lodge a complaint with the National Data Protection Commissioner (NDPC) if you believe that we have violated your data protection rights.
         We may transfer your personal data outside Nigeria for the purposes described in this privacy policy. We only transfer your personal data to countries that have adequate data protection laws or that have obtained your consent. 
         We also implement appropriate technical and organizational measures to ensure the security and confidentiality of your personal data during the transfer. 
         We may update this clause from time to time to reflect changes in the law or our data practices. We will notify you of any material changes by posting a notice on our website or by sending you an email. 
         Your continued use of our website or services after the notice period will constitute your acceptance of the changes.
        </p>
          ...
          <h5>15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h5> 
          <p>
          ...
          To request to review, update, or delete your personal information, please submit an email at: 
          contact@jucko.com
          </p>
    </div>
